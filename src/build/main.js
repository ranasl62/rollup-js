...
jquery(document).ready(function () {
    ...
    jquery(".chat-closed").on("click", function (e) {
        var b;
    ...
    jquery('#input_message').on('keyup', function (e) {
        const input_message = jquery('#input_message').val();
        if (!input_message) {
            return
        }
        if (e.keyCode === 13) {
    ...
    function submit_message(message) {
        jquery.post("https://9a2d3534.ngrok.io/send_message", {message: message}, handle_response);
        ...
        function handle_response(data) {
            ...
            if (!data.message) {
                return jquery('.chat-container').append(`
                <div class="text_bot">
            ...
            if (data.message == 'Human active') {
                return jquery("#chat_box_loading").remove();
            }
        ...
        `);
            div_bottom();
            jquery.post("https://9a2d3534.ngrok.io/button_reply", {btn_query: data.message}, button_response);

            function button_response(reply) {
                // remove the chat_box_loading indicator
                jquery("#chat_box_loading").remove();

                jquery.each(reply, function (index, element) {
                    jquery('.chat-container').append(`
    ...
    jquery('.chat-container').on('click', '#button_reply', function (e) {
        e.preventDefault();
        var button_message = jquery(this).text();
        button_info(button_message);
    });

    jquery('.chat-container').on('click', '#change_lang_btn', function (e) {
        e.preventDefault();
        var button_message = jquery(this).text();
        button_info(button_message);
    });

    jquery('.chat-container').on('click', '#banking_query_btn', function (e) {
        e.preventDefault();
        var button_message = jquery(this).text();
        button_info(button_message);
    });

    jquery('.chat-container').on('click', '#topup_button', function (e) {
        e.preventDefault();
        var button_message = jquery(this).text();
        button_info(button_message);
    });
